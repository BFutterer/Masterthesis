...
L.Control.OSMGeocoder = L.Control.extend({
	options: {
		...
		bounds: null, 																															// L.LatLngBounds		a L.LatLngBounds object to limit the results to
		email: null, 																																// String						an email string with a contact to provide to Nominatim. Useful if you are doing lots of queries
	...
	onAdd: function (map) {
		...
		if (this.options.collapsed) {
			L.DomEvent.addListener(container, 'click', this._expand, this); 					//was mouseover
			L.DomEvent.addListener(container, 'dblclick', this._collapse, this);			//was mouseout
	...
	_geocode : function (event) {
		...
		var url = protocol + "//nominatim.openstreetmap.org/search" + L.Util.getParamString(params),			//send a request to nominatim (max one per second) 	https://operations.osmfoundation.org/policies/nominatim/
